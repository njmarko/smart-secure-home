...
export class CsrFormComponent implements OnInit {
  ...
  generateCSR(): void {
    ...
    this.csr.x500Name.country = this.csr.x500Name.country ? this.csr.x500Name.country : "RS";
    this.csr.x500Name.state = this.csr.x500Name.state ? this.csr.x500Name.state : "Juznobacki Okrug";
    this.csr.x500Name.locale = this.csr.x500Name.locale ? this.csr.x500Name.locale : "Novi Sad";
    this.csr.x500Name.organization = this.csr.x500Name.organization ? this.csr.x500Name.organization : "Fakultet tehnickih nauka";
    this.csr.x500Name.organizationUnit = this.csr.x500Name.organizationUnit ? this.csr.x500Name.organizationUnit : "Departman za elektrotehniku i racunarstvo";
    this.csr.x500Name.commonName = this.csr.x500Name.commonName ? this.csr.x500Name.commonName : "Dusan Hajduk";
