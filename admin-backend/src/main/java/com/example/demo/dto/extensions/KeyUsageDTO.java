...
public class KeyUsageDTO extends ExtensionDTO {
	...
	public int toBitMask() {
		...
		hashMap.put(KeyUsageEnumDTO.KEY_ENCIPHERMENT, 32);
		hashMap.put(KeyUsageEnumDTO.CRL_SIGN, 2);
		hashMap.put(KeyUsageEnumDTO.DIGITAL_SIGNATURE, 128);
		hashMap.put(KeyUsageEnumDTO.CERTIFICATE_SIGNING, 4);
